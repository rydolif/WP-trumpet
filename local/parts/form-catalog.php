	<section class="section-catalog section-order" data-bg="<?php echo get_template_directory_uri(); ?>/assets/img/tabs--bg.jpg">
		<div class="container">
			...
			<div class="section-order__form section-catalog__form form">
				<div class="section-order__block">
					<p class="h3">Форма на запрос каталога</p>
					<?php echo do_shortcode( '[contact-form-7 id="284" title="ФОРМА НА ЗАПРОС КАТАЛОГА"]' ); ?>
				</div>
